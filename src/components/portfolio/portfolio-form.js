// Steps to creating forms:
// Create state
// Create form elements
// Create event handlers (change/submit)
// Bind event handlers
...
export default class PortfolioForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            logo: "",
            editMode: false,
            apiUrl: "https://ashtonwashburn.devcamp.space/portfolio/portfolio_items",
            apiAction: "post"
        };
    ...
    componentDidUpdate() {
        if (Object.keys(this.props.portfolioToEdit).length > 0) {
            ...
            this.setState({
                ...
                url: url || "",
                editMode: true,
                apiUrl: `https://ashtonwashburn.devcamp.space/portfolio/portfolio_items/${id}`,
                apiAction: "patch",
    ...
    buildForm() {  // When building a form with image input
